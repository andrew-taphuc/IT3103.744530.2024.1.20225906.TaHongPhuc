...
//	private List<Media_phucth> itemsOrdered = new ArrayList<Media_phucth>();
    private ObservableList<Media_phucth> itemsOrdered = FXCollections.observableArrayList();

    public ObservableList<Media_phucth> getItemsOrdered() {
        return itemsOrdered;
    }
	...
	public void removeMedia_phucth(Media_phucth media) {
	    boolean found = false;
	    for (int i = 0; i < itemsOrdered.size(); i++) {
